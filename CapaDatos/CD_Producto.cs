    ...
    public class CD_Producto
    {
        ...
        public int Registrar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                ...
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    cmd.Parameters.AddWithValue("Nombre", obj.oMarca.IdMarca);
                    cmd.Parameters.AddWithValue("Nombre", obj.oCategoria.IdCategoria);
        ...
        public bool GuardarDatosImagen(Producto oProducto,out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    string query = "update producto set RutaImagen = @rutaiamgen, NombreImagen = @nombreimagen where IdProducto = @idproducto";
                    SqlCommand cmd = new SqlCommand("sp_RegistrarProducto", oconexion);
                    cmd.Parameters.AddWithValue("@rutaiamgen", oProducto.RutaImagen);
